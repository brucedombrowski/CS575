<div class="dictationAssignments index">
	...
	<tr>
		...
		<td><?php echo h($dictationAssignment['DictationAssignment']['account_manager_id']); ?>&nbsp;</td>
		<td><?php echo h($dictationAssignment['DictationAssignment']['transcriptionist_id']); ?>&nbsp;</td>
